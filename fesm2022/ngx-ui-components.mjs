...
import { Injectable, Component, NgModule, Input, ContentChildren, Directive, EventEmitter, Output, booleanAttribute, numberAttribute, ChangeDetectionStrategy } from '@angular/core';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: CarouselComponent, decorators: [{
        ...
        }], ctorParameters: function () { return []; }, propDecorators: { carouselItems: [{
                type: ContentChildren,

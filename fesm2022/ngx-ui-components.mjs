...
class ExpansionPanelComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: ExpansionPanelComponent, selector: "ngx-expansion-panel", inputs: { disabled: "disabled", label: "label", ngxType: "ngxType", color: "color" }, outputs: { onClick: "onClick" }, ngImport: i0, template: "<div\r\n  class=\"mb-4 p-4\"\r\n  [ngClass]=\"{ 'rounded-lg box-shadow': ngxType === 'card' }\"\r\n>\r\n  <div\r\n    (click)=\"expand()\"\r\n    class=\"flex justify-between w-full text-lg font-semibold text-white cursor-pointer h-10 items-center\"\r\n  >\r\n    <span [ngStyle]=\"{ color: color }\">{{ label }}</span>\r\n    <span\r\n      class=\"flex justify-center items-center\"\r\n      [ngClass]=\"expanded ? 'rotate' : 'no-rotate'\"\r\n    >\r\n      <svg\r\n        [ngStyle]=\"{ fill: color }\"\r\n        xmlns=\"http://www.w3.org/2000/svg\"\r\n        height=\"24\"\r\n        viewBox=\"0 -960 960 960\"\r\n        width=\"24\"\r\n      >\r\n        <path d=\"M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z\" />\r\n      </svg>\r\n    </span>\r\n  </div>\r\n  <ng-content *ngIf=\"expanded\"></ng-content>\r\n  <ngx-divider class=\"mt-4\" *ngIf=\"ngxType === 'normal'\"></ngx-divider>\r\n</div>\r\n", styles: [":host{width:100%;background-color:transparent}.rotate{rotate:180deg;transition:rotate .2s ease-out}.no-rotate{rotate:0deg;transition:rotate .2s ease-out}.box-shadow{box-shadow:0 3px 1px -2px #0003,0 2px 2px #00000024,0 1px 5px #0000001f}.mt-4{margin-top:1rem}.mb-4{margin-bottom:1rem}.p-4{p:1rem}\n"], dependencies: [{ kind: "directive", type: i1.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "directive", type: i1.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: i1.NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }, { kind: "component", type: DividerComponent, selector: "ngx-divider", inputs: ["ngxText"] }] }); }
}
